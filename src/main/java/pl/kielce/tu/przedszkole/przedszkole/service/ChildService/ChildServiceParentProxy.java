...
@Service
public class ChildServiceParentProxy implements ChildService{

    private final Logger logger = Logger.getLogger(ChildServiceParentProxy.class.getName());
    private final ChildServiceImpl childServiceImpl;

    @Autowired
    public ChildServiceParentProxy(ChildServiceImpl childServiceImpl) {
